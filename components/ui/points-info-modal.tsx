    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between p-6 border-b border-border bg-warning/10">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-warning/20 rounded-full flex items-center justify-center">
                  <Star className="w-5 h-5 text-warning" />
                </div>
                <div>
                  <h2 className="text-xl font-bold text-foreground">Points System</h2>
            ...
            <div className="overflow-y-auto flex-1 p-6" style={{ maxHeight: 'calc(90vh - 200px)' }}>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3 p-4 bg-success/10 rounded-lg border border-success/20">
                      ...
                      <div>
                        <h4 className="font-semibold text-success">Complete a Poll</h4>
                    ...
                    <div className="flex items-start gap-3 p-4 bg-accent/10 rounded-lg border border-accent/20">
                      ...
                      <div>
                        <h4 className="font-semibold text-accent">Consecutive Poll Bonus</h4>
                        <p className="text-sm text-muted-foreground mt-1">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3 p-4 bg-warning/10 rounded-lg border border-warning/20">
                      ...
                      <div>
                        <h4 className="font-semibold text-warning">Boost Your Polls</h4>
                        <p className="text-sm text-muted-foreground mt-1">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-secondary/10 rounded-lg border border-secondary/20">
                      ...
                      <div>
                        <h4 className="font-semibold text-secondary">Future Features</h4>
                        <p className="text-sm text-muted-foreground mt-1">
                ...
                {/* Boost Pricing */}
                <div>
                  <h3 className="text-lg font-semibold mb-4">💰 Boost Pricing</h3>
                ...
                <div className="bg-muted/50 rounded-lg p-4 border">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-warning">{currentPoints}</div>
