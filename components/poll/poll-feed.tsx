  ...
  return (
    <>
      <div className="space-y-6">
        ...
        {!user && !loading && (
          <div className="text-center py-6 sm:py-10 px-3 sm:px-4 bg-card/50 rounded-lg sm:rounded-xl border border-border/30">
            ...
            <h3 className="text-base sm:text-lg font-bold text-foreground mb-2">Sign In to View Polls</h3>
            <p className="text-muted-foreground mb-4 sm:mb-5 max-w-sm mx-auto text-xs sm:text-sm leading-relaxed">
              Join our community to explore polls, share your opinions, and earn points.
            </p>
            
            {/* Features Preview - More compact */}
            <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-4 sm:mb-5 max-w-xs sm:max-w-md mx-auto">
              <div className="bg-white/50 rounded-md sm:rounded-lg p-2 sm:p-3 border border-border/20">
                <div className="text-lg sm:text-xl mb-1">🗳️</div>
                <div className="font-semibold text-xs">Vote</div>
              </div>
              <div className="bg-white/50 rounded-md sm:rounded-lg p-2 sm:p-3 border border-border/20">
                <div className="text-lg sm:text-xl mb-1">⭐</div>
                <div className="font-semibold text-xs">Earn Points</div>
              </div>
              <div className="bg-white/50 rounded-md sm:rounded-lg p-2 sm:p-3 border border-border/20">
                <div className="text-lg sm:text-xl mb-1">🚀</div>
                <div className="font-semibold text-xs">Boost</div>
              </div>
            </div>
            ...
            <button 
              ...
              className="inline-flex items-center gap-2 bg-primary text-white px-4 sm:px-5 py-2 sm:py-2.5 rounded-md sm:rounded-lg font-semibold hover:bg-primary/90 transition-all hover:scale-105 shadow-lg text-xs sm:text-sm"
            >
